...
public class Biometrics extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_FOD_ANIM = "fod_recognizing_animation_list";
    ...
    public void onCreate(Bundle icicle) {
        ...
        mFodAnim = (ListPreference) findPreference(KEY_FOD_RECOGNIZING_ANIMATION_LIST);
            ...
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    if (!DeviceUtils.hasFod(context)) {
                        ...
                        keys.add(KEY_FOD_RECOGNIZING_ANIMATION_LIST);
